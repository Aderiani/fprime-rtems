...
#define CONFIGURE_EXECUTIVE_RAM_SIZE	(100*1024*1024) // 100MB
#define CONFIGURE_INIT_TASK_STACK_SIZE (2*1024 * 1024) // 1MB
#define CONFIGURE_MALLOC_STATISTICS
#define CONFIGURE_NETWORK_MBUF_BYTES (256*1024)        // 256KB for mbufs
#define CONFIGURE_NETWORK_MBUF_CLUSTER_BYTES (512*1024)  // 512KB for mbuf clusters


// System resources
#define CONFIGURE_MAXIMUM_TASKS 100
#define CONFIGURE_MAXIMUM_SEMAPHORES 100
#define CONFIGURE_MAXIMUM_MESSAGE_QUEUES 500
