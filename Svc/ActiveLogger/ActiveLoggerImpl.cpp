...
void ActiveLoggerImpl::LogRecv_handler(FwIndexType portNum,
                                       FwEventIdType id,
                                       Fw::Time& timeTag,
...
void ActiveLoggerImpl::loqQueue_internalInterfaceHandler(FwEventIdType id,
...
void ActiveLoggerImpl::SET_EVENT_FILTER_cmdHandler(FwOpcodeType opCode,
                                                   U32 cmdSeq,
...
void ActiveLoggerImpl::SET_ID_FILTER_cmdHandler(FwOpcodeType opCode,  //!< The opcode
...
void ActiveLoggerImpl::DUMP_FILTER_STATE_cmdHandler(FwOpcodeType opCode,  //!< The opcode
                                                    U32 cmdSeq            //!< The command sequence number
) {
...
void ActiveLoggerImpl::pingIn_handler(const FwIndexType portNum, U32 key) {
    // return key
