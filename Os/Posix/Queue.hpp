// ======================================================================
// \title Os/Posix/Queue.hpp
// \brief posix definitions for Os::Queue
// ======================================================================
...
class PosixQueue : public QueueInterface {
  public:
    ...
    PosixQueue& operator=(const QueueInterface& other) override = delete;
